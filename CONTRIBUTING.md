...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork:
    ...
    ```
    # Clone your fork
    git clone https://github.com/<your-username>/react-polling-hook.git

    # Navigate to the newly cloned directory
    cd react-polling-hook
    ```
...
>
> ```
> git remote add upstream https://github.com/vivek12345/react-polling-hook.git
> git fetch upstream
